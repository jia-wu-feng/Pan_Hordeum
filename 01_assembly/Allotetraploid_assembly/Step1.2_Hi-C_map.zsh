...
ref='/filer-dg/agruppen/dg6/fengj/panhordeum/assembly/hjubatum/hjubatum_hifiasm.fasta'
...
$map --threads 50 --mem '200G' --linker "GATCGATC" --ref $ref --bed $bed --tmp $TMPDIR /filer-dg/agruppen/dg6/fengj/panhordeum/assembly/hjubatum/hic/hicreads
