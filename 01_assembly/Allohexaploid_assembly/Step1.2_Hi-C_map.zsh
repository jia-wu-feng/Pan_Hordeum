...
ref='/filer-dg/agruppen/dg7/fengj/genome/hparodii/hparodii.fasta'
...
$map --threads 50 --mem '200G' --linker "GATCGATC" --ref $ref --bed $bed --tmp $TMPDIR /filer-dg/agruppen/dg6/fengj/panhordeum/assembly/hparodii/hic/hicreads
