...
#Function to combine the Hi-C maps from 3 subgenomes
...
readRDS(file="hparodii_assembly_v2_haplotype_separation_v0.Rds") -> pq
readRDS(file="hparodii_assembly_v2_Hv_guide+HiClift.Rds") -> cc

readRDS('hparodii_assembly_v2.Rds') -> assembly_v2
readRDS('hparodii_assembly_v2_cov.Rds') -> cov
...
saveRDS(hap_lift0, file="hparodii_assembly_v2_hap_lift0.Rds") 

readRDS("hparodii_assembly_v2_hap_lift0.Rds") -> hap_lift0

#keep contigs unassigned to one subgenome
hap_lift0 -> hap_lift
...
#combine both subgenome tables
rbind(pq[, .(scaffold=contig, hap)],  hap_lift[, .(scaffold, hap)]) -> hh
hh[cc, on="scaffold"] -> hh
saveRDS(hh, file="hparodii_assembly_v2_Hv_guide+HiClift+hap1.Rds") 
...
f <- '../hparodii_MboI_fragments_30bp.bed'
...
hh[hap %in% c(1,12,13,123), .(scaffold, length, chr=as.integer(substr(chr, 4, 4)), cM = pos/1e6)] -> hic_info
...
saveRDS(hic_map_v1_hap1, file="hparodii_hifiasm_map_v1_hap1.Rds")

#Hi-C map for subgenome 2
hh[hap %in% c(2,12,23,123), .(scaffold, length, chr=as.integer(substr(chr, 4, 4)), cM = pos/1e6)] -> hic_info
frag_data$info[, .(scaffold, nfrag)][hic_info, on="scaffold"] -> hic_info
...
saveRDS(hic_map_v1_hap2, file="hparodii_hifiasm_map_v1_hap2.Rds")


#Hi-C map for subgenome 3
hh[hap %in% c(3,13,23,123), .(scaffold, length, chr=as.integer(substr(chr, 4, 4)), cM = pos/1e6)] -> hic_info
frag_data$info[, .(scaffold, nfrag)][hic_info, on="scaffold"] -> hic_info
...
saveRDS(hic_map_v1_hap3, file="hparodii_hifiasm_map_v1_hap3.Rds")


#create Hi-C plots for subgenome 1
snuc <- '../hparodii_MboI_fragments_30bp_split.nuc.txt'
hic_plots(rds="hparodii_hifiasm_map_v1_hap1.Rds", cov=F, assembly=assembly_v2, cores=30, species="barley", nuc=snuc) -> hic_map_v1_hap1_l

#create Hi-C plots for subgenome 2
snuc <- '../hparodii_MboI_fragments_30bp_split.nuc.txt'
hic_plots(rds="hparodii_hifiasm_map_v1_hap2.Rds", cov=F, assembly=assembly_v2, cores=30, species="barley", nuc=snuc) -> hic_map_v1_hap2_l

#create Hi-C plots for subgenome 3
snuc <- '../hparodii_MboI_fragments_30bp_split.nuc.txt'
hic_plots(rds="hparodii_hifiasm_map_v1_hap3.Rds", cov=F, assembly=assembly_v2, cores=30, species="barley", nuc=snuc) -> hic_map_v1_hap3_l



#combine both Hi-C maps
readRDS("hparodii_hifiasm_map_v1_hap1.Rds")->hic_map_v1_hap1
readRDS("hparodii_hifiasm_map_v1_hap2.Rds")->hic_map_v1_hap2
readRDS("hparodii_hifiasm_map_v1_hap3.Rds")->hic_map_v1_hap3


combine_hic(hh,hic_map_v1_hap1, hic_map_v1_hap2, hic_map_v1_hap3,assembly_v2) -> ch
...
f <- "hparodii_map_v1_interchromosomal.png"
interchromosomal_matrix_plot(hic_map=hic_map_v1_l, file=f,  species="hordeum_hexaploid_6x")

#write Hi-C map for editing
write_hic_map(rds="hparodii_hifiasm_map_v1_hap1.Rds", file="hparodii_hifiasm_map_v1_hap1.xlsx", species="barley")
write_hic_map(rds="hparodii_hifiasm_map_v1_hap2.Rds", file="hparodii_hifiasm_map_v1_hap2.xlsx", species="barley")
write_hic_map(rds="hparodii_hifiasm_map_v1_hap3.Rds", file="hparodii_hifiasm_map_v1_hap3.xlsx", species="barley")
...
sink("hparodii_pseudomolecules_v1_hap1.log")
compile_psmol(fasta=fasta, output="hparodii_pseudomolecules_v1_hap1", hic_map=hic_map_v1_hap1, assembly=assembly_v2, cores=30)
sink()

sink("hparodii_pseudomolecules_v1_hap2.log")
compile_psmol(fasta=fasta, output="hparodii_pseudomolecules_v1_hap2", hic_map=hic_map_v1_hap2, assembly=assembly_v2, cores=30)
sink()

sink("hparodii_pseudomolecules_v1_hap3.log")
compile_psmol(fasta=fasta, output="hparodii_pseudomolecules_v1_hap3", hic_map=hic_map_v1_hap3, assembly=assembly_v2, cores=30)
sink()
...
read_hic_map(rds="hparodii_hifiasm_map_v1_hap1.Rds", file="hparodii_hifiasm_map_v1_hap1_edit.xlsx") -> nmap
hic_map(species="barley", agp_only=T, map=nmap)->hic_map_v2_hap1
saveRDS(hic_map_v2_hap1, file="hparodii_hifiasm_map_v2_hap1.Rds")

read_hic_map(rds="hparodii_hifiasm_map_v1_hap2.Rds", file="hparodii_hifiasm_map_v1_hap2_edit.xlsx") -> nmap
hic_map(species="barley", agp_only=T, map=nmap)->hic_map_v2_hap2
saveRDS(hic_map_v2_hap2, file="hparodii_hifiasm_map_v2_hap2.Rds")

read_hic_map(rds="hparodii_hifiasm_map_v1_hap3.Rds", file="hparodii_hifiasm_map_v1_hap3_edit.xlsx") -> nmap
hic_map(species="barley", agp_only=T, map=nmap)->hic_map_v2_hap3
saveRDS(hic_map_v2_hap3, file="hparodii_hifiasm_map_v2_hap3.Rds")
...
#create Hi-C plots for subgenome 1
snuc <- '../hparodii_MboI_fragments_30bp_split.nuc.txt'
hic_plots(rds="hparodii_hifiasm_map_v2_hap1.Rds", cov=F, assembly=assembly_v2, cores=30, species="barley", nuc=snuc) -> hic_map_v2_hap1_l

#create Hi-C plots for subgenome 2
snuc <- '../hparodii_MboI_fragments_30bp_split.nuc.txt'
hic_plots(rds="hparodii_hifiasm_map_v2_hap2.Rds", cov=F, assembly=assembly_v2, cores=30, species="barley", nuc=snuc) -> hic_map_v1_hap2_l

#create Hi-C plots for subgenome 3
snuc <- '../hparodii_MboI_fragments_30bp_split.nuc.txt'
hic_plots(rds="hparodii_hifiasm_map_v2_hap3.Rds", cov=F, assembly=assembly_v2, cores=30, species="barley", nuc=snuc) -> hic_map_v1_hap3_l



readRDS('hparodii_assembly_v2.Rds') -> assembly_v2
readRDS('hparodii_hifiasm_map_v2_hap1.Rds') -> hic_map_v2_hap1
readRDS('hparodii_hifiasm_map_v2_hap2.Rds') -> hic_map_v2_hap2
readRDS('hparodii_hifiasm_map_v2_hap3.Rds') -> hic_map_v2_hap3


fasta <- '/filer-dg/agruppen/dg7/fengj/genome/hparodii/hparodii.fasta'

sink("hparodii_pseudomolecules_v2_hap1.log")
compile_psmol(fasta=fasta, output="hparodii_pseudomolecules_v2_hap1", hic_map=hic_map_v2_hap1, assembly=assembly_v2, cores=30)
sink()

sink("hparodii_pseudomolecules_v2_hap2.log")
compile_psmol(fasta=fasta, output="hparodii_pseudomolecules_v2_hap2", hic_map=hic_map_v2_hap2, assembly=assembly_v2, cores=30)
sink()

sink("hparodii_pseudomolecules_v2_hap3.log")
compile_psmol(fasta=fasta, output="hparodii_pseudomolecules_v2_hap3", hic_map=hic_map_v2_hap3, assembly=assembly_v2, cores=30)
sink()


readRDS(file="hparodii_assembly_v2_Hv_guide+HiClift+hap1.Rds") -> hh

combine_hic(hh,hic_map_v2_hap1, hic_map_v2_hap2, hic_map_v2_hap3,assembly_v2) -> ch2
...
f <- "hparodii_map_v2_interchromosomal.png"
interchromosomal_matrix_plot(hic_map=hic_map_v2_l, file=f,  species="hordeum_hexaploid_6x")
